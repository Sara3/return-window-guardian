  ...
  return (
    <div className="py-3 border-t border-border">
      ...
      <div className="flex items-center gap-2 mb-3">
        <Truck className="w-4 h-4" style={{ color: "#0066CC" }} />
      ...
      <div className="relative">
        ...
        <div
          className="absolute top-2 left-[12.5%] h-0.5 -z-0 transition-all bg-[#0066CC]"
          style={{
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
      <div className="bg-card border border-border rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-4 border-b border-border">
          <div className="flex items-center gap-2">
            <RotateCcw className="w-5 h-5" style={{ color: "#0066CC" }} />
        ...
        <div className="p-4 border-b border-border bg-secondary/30">
          <div className="flex justify-between items-start">
            ...
            <span className="font-semibold flex-shrink-0" style={{ color: "#0066CC" }}>
              {purchase.amount}
            </span>
          </div>
        </div>
  ...
  return (
    <div className={`border rounded-lg p-4 relative ${isUrgent ? "border-red-500/50 bg-red-500/5" : "border-border bg-card"}`}>
      ...
      <div className="flex justify-between items-start mb-3 pr-6">
        ...
        <span className="text-lg font-bold flex-shrink-0" style={{ color: "#0066CC" }}>
          {purchase.amount}
        </span>
      </div>
        ...
        if (purchase.status === "return_initiated") {
          return (
            <div className="py-3 border-t border-border space-y-3">
              <div className="flex items-center gap-2">
                <RefreshCw className="w-4 h-4" style={{ color: "#0066CC" }} />
              ...
              <div className="relative">
                ...
                <div className="absolute top-2 left-[16.5%] h-0.5 -z-0 transition-all bg-[#0066CC]" style={{ width: "33%" }} />
              </div>
      ...
      {(() => {
        ...
        return (
          ...
          >
            <div className="flex items-center gap-2">
              <Store className="w-4 h-4" style={{ color: "#0066CC" }} />
      ...
      {purchase.cardProtection.windowDays && (!purchase.storePolicy.windowDays || (storeDaysLeft !== null && storeDaysLeft < 0)) && (
        <div className="flex items-center justify-between py-2 border-t border-border">
          <div className="flex items-center gap-2">
            <Shield className="w-4 h-4" style={{ color: "#0066CC" }} />
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          <select
            ...
            className="w-full appearance-none bg-secondary/50 border border-border rounded-lg px-4 py-2.5 pr-10 text-sm font-medium text-foreground cursor-pointer hover:bg-secondary transition-colors focus:outline-none focus:ring-2 focus:ring-[#0066CC]/50"
          >
            <option value="all">
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-full">
        <LoadingIcon className="w-6 h-6 text-[#0066CC]" />
      </div>
    );
  }
    ...
    <div className="h-full flex flex-col p-3">
      ...
      <div className="flex-1 flex flex-col justify-center space-y-2">
        <div className="text-center">
          <div className="text-3xl font-bold" style={{ color: "#0066CC" }}>
            {totalTracked}
          </div>
...
function AppView() {
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="border-b border-border px-6 py-4" style={{ backgroundColor: "#0066CC" }}>
